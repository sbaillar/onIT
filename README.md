...
| Part | Notes |
|---|---|
| [Waveshare ESP32-S3-Touch-LCD-1.28](https://www.waveshare.com/wiki/ESP32-S3-Touch-LCD-1.28) | 1.28" round IPS LCD (GC9A01, 240×240), CST816S touch, CH343P USB-UART. **USB only.** |
...
No soldering, no wiring — flash either board over its USB cable. The AMOLED
board then works untethered: tray → **Pair busylight…**, type the 6-digit
...
- `firmware/busylight_round/` — 1.28" LCD sketch (Arduino_GFX, board: ESP32S3 Dev Module)
